...
class InvidiousAPI:
    def __init__(self):
        self.all = ast.literal_eval(requests.get('https://raw.githubusercontent.com/M-14-deep/Siken5/refs/heads/main/API.html', headers=getRandomUserAgent(), timeout=(1.0, 0.5)).text)
